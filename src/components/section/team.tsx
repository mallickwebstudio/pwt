          ...
          <li className='relative rounded-4xl overflow-hidden' key={item.name + index + 'TeamCTwoAlignLeft'}>
            <FadeInUp delayOffset={index * 0.2}>
              <article className='relative group aspect-3/4'>
                ...
                <div className="absolute inset-0 top-1/2 bottom-1/2 -translate-y-1/2 left-[50%] right-1/2 -translate-x-1/2 size-full">
                  <Image
                    className="size-full object-cover opacity-0 scale-0 select-none pointer-events-none group-hover:scale-100 group-hover:opacity-100 transition-all duration-300 rounded-4xl"
                    width={32}
                    height={32}
                    src="/images/bg/yellow-t.png"
                    alt={"Background"}
                    unoptimized
                  />
                </div>
                ...
                <figure className='block absolute inset-0'>
                  <Image
                    className="size-full object-cover select-none pointer-events-none rounded-md scale-110 group-hover:scale-115 transition-all duration-300"
                    src={item.image.url}
                    width={400}
                    height={40}
                    alt={item.image.alt}
